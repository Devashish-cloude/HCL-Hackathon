...
import { Search, Clock, BookOpen, Sparkles, Filter } from 'lucide-react';
...
export const ExplorePage: React.FC = () => {
  ...
  const categories = ['ALL', 'Frontend', 'Backend', 'Full Stack', 'Data Structures'];
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-stretch sm:items-center">
        ...
        <form onSubmit={handleSearchSubmit} className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-xs sm:text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </form>
      </div>
